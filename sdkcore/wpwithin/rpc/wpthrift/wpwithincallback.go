...
//  - ServiceDeliveryToken
//  - UnitsToSupply
func (p *WPWithinCallbackClient) BeginServiceDelivery(clientId string, serviceDeliveryToken *wpthrift_types.ServiceDeliveryToken, unitsToSupply int32) (err error) {
...
func (p *WPWithinCallbackClient) sendBeginServiceDelivery(clientId string, serviceDeliveryToken *wpthrift_types.ServiceDeliveryToken, unitsToSupply int32) (err error) {
...
//  - ServiceDeliveryToken
//  - UnitsReceived
func (p *WPWithinCallbackClient) EndServiceDelivery(clientId string, serviceDeliveryToken *wpthrift_types.ServiceDeliveryToken, unitsReceived int32) (err error) {
...
func (p *WPWithinCallbackClient) sendEndServiceDelivery(clientId string, serviceDeliveryToken *wpthrift_types.ServiceDeliveryToken, unitsReceived int32) (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
...
func (p *WPWithinCallbackBeginServiceDeliveryArgs) GetClientId() string {
	return p.ClientId
}
...
func (p *WPWithinCallbackEndServiceDeliveryArgs) GetClientId() string {
	return p.ClientId
}
