...
type Price struct {
	...
	PricePerUnit    *PricePerUnit `thrift:"pricePerUnit,3" json:"pricePerUnit"`
	UnitId          int32         `thrift:"unitId,4" json:"unitId"`
	UnitDescription string        `thrift:"unitDescription,5" json:"unitDescription"`
}
