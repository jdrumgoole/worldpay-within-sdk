            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.services = new HashMap<Integer,Service>(2*_map10.size);
                int _key11;
                Service _val12;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Device struct) throws org.apache.thrift.TException {
      ...
      if (struct.services != null) {
        oprot.writeFieldBegin(SERVICES_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, Service> _iter14 : struct.services.entrySet())
          {
      ...
      if (struct.isSetServices()) {
        {
          ...
          for (Map.Entry<Integer, Service> _iter15 : struct.services.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.services = new HashMap<Integer,Service>(2*_map16.size);
          int _key17;
          Service _val18;
